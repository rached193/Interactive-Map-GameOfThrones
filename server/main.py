    ...
    def post(self):
        ...
        if checkres is None:
            ...
            if perso is None:
                ...
                self.SendJson(
                    {'nickname': checkres.name, 'casa': checkres.casa, 'personaje': perso.nombre, 'sexo': perso.sexo})
...
class Personaje(RestHandler):
    def get(self, user):
        ...
        if checkres is None:
            ...
            self.SendJson(
                {'user': checkres.user, 'nombre': checkres.nombre, 'edad': checkres.edad, 'historia': checkres.historia,
                 'apariencia': checkres.apariencia})
