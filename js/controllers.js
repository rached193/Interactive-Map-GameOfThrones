...
app.controller("ControladorSelecionarCasa",['$scope','$cookies','$http','$location',function($scope,$cookies,$http,$location){
  ...
  {nombre:"Casa Karstark",  provincia:"Bastion Kar", escudo:"karstark.png",plot:" Los Karstark son una casa noble del Norte, vasallos de los Stark y rama cadete de dicha familia (fundada por Karlon Stark como recompensa por ayudar a terminar la rebelión de los Bolton). Su lema es: ‘El Sol de invierno’."},
  {nombre:"Casa Glover",  provincia:"Bosquespeso", escudo:"glover.png",plot:" Se trata de una casa noble del Norte, vasalla de los Stark. Antes de que los Stark los sometieran, ellos eran los reyes en el norte."},
  {nombre:"Casa Manderly",  provincia:"Puerto Blanco", escudo:"manderly.png",plot:" La Casa Manderly es una casa vasalla del Norte, bajo el dominio de la Casa Stark. Gobiernan Puerto Blanco, la menor de las cinco ciudades más importantes de Poniente, siendo el principal puerto del Norte y sede del comercio fluvial de la zona con el Sur. "},
  {nombre:"Casa Tallhart",  provincia:"Ciedadela de Torrhen", escudo:"tallhart.png",plot:" Casa noble del Norte, vasalla de los Stark. Sigue a los Antiguos Dioses y posee un asentamiento fuerte, pero no inexpugnable. Su lema es: ‘Orgullosos y libres’."},
  {nombre:"Casa Fenn",  provincia:"Foso Cailin", escudo:"fenn.png",plot:" La Casa Fenn está al cargo de la fortaleza ubicada en el límite Norte de la gran ciénaga (El Cuello), uno de los bastiones más importantes del Norte pese a encontrarse en ruinas. Su importancia radica en que es la única ruta segura para que los ejércitos pasen por la ciénaga (punto defensivo natural muy eficaz). La única forma de evitar pasar es ganándose la lealtad de los lacustres, quienes conocen pasos alternativos por el pantano."},
  {nombre:"Casa Flint",  provincia:"Dedo de Perdernal", escudo:"flint.png",plot:" La Casa Flint pertenece al territorio del Norte, y por ende es vasalla de la Casa Stark. Defensores de la tradición, siguen el culto a los Dioses Antiguos."},
  {nombre:"Casa Reed",  provincia:"Atalaya de Aguasdulces", escudo:"reed.png",plot:" Casa vasalla de los Stark, a la cual juraron lealtad hace más de mil años cuando se alzaron como Reyes del Norte. Situada en los pantanos del Cuello (se trata de una serie de islas flotantes, por lo cual su ubicación precisa es inexacta)."},
  {nombre:"Casa Mallister",  provincia:"Varamar", escudo:"mallister.png",plot:" Casa vasalla de los Tully, situada en la costa oeste de las Tierras de los Ríos. Por las amenazas de pillaje de los Hombre del Hierro, han desarrollado una fortaleza para proteger a su gente. Su lema es: ‘Por encima del resto’."},
  {nombre:"Casa Frey",  provincia:"Huescas", escudo:"frey.png",plot:" La Casa Frey pertenece al territorio de la Casa Tully. El nombre de sus tierras viene dado por dos castillos idénticos y el cruce fortificado del río que hay entre ellos (siendo el principal punto de acceso al Norte). Por ello es una de las casas más poderosas de las Tierras de los Ríos, enriquecida al cobrar peaje por permitir el paso (aunque de poco prestigio)."},
  {nombre:"Casa Tollett",  provincia:"Soto Gris", escudo:"tollett.png",plot:" La Casa Tollett se encuentra en los dominios del Valle de Arryn. Siguen la Fe de los Siete y su lema es: ‘Cuando todo es más oscuro’."},
  {nombre:"Casa Coldwater",  provincia:"Comezón de Aguasfrías", escudo:"coldwater.png",plot:" Vasallos de la Casa Arryn, situados cerca de la desembocadura del río de Los Dedos. Son descendientes de los primeros hombres a diferencia de la mayor parte del valle, de ascendencia de los Ándalos."},
  {nombre:"Casa Mudd",  provincia:"Piedrasviejas", escudo:"mudd.png",plot:" Casa de las Tierras de los Ríos, por tanto vasalla de los Tully. Antes, gobernaron como Reyes de los Ríos y las Colinas. La fortaleza fue construida durante la invasión ándala para los reyes Mudd (derrotados en dicha contienda)."},
  {nombre:"Casa Hawick",  provincia:"Salinas", escudo:"hawick.png",plot:" Es una pequeña ciudad portuaria dentro de las Tierras de los Ríos, en la desembocadura del Tridente, por lo cual tienen un  importante flujo comercial.  Cuenta con un pequeño castillo amurallado que domina el pueblo y el puerto."},
  {nombre:"Casa Whent",  provincia:"Harrenhal", escudo:"whent.png",plot:" Es el castillo más grande de los Siete Reinos, ubicado en las Tierras de los Ríos (en la orilla norte del Lago Ojo de los Dioses). La Casa Whent es la séptima en asentarse en el castillo."},
  {nombre:"Casa Blackwood",  provincia:"Árbol de los Cuervos", escudo:"blackwood.png",plot:" Vasalla de los Tully y asentada en las Tierras de los Ríos. Poseen una gran extensión de tierras que, según la leyenda, antaño pertenecieron a Seto de Piedra. Anteriormente también gobernaban el bosque de los lobos, hasta que los Reyes del Invierno les expulsaron, pero en lugar de arrodillarse huyeron al sur y desde entonces gobiernan en Árbol de los Cuervos como reyes menores."},
  {nombre:"Casa Banefort",  provincia:"Fuerte Desolación", escudo:"banefort.png",plot:" Localizada en las Tierras del Oeste, bajo el mando de la Casa Lannister. Su localización en la costa convierten sus tierras en el punto más cercano a Pyke (a dos días de viaje en barco). Su casa desciende de un héroe, llamado el Encapuchado, que vivió en la época de los Primeros Hombres."},
  {nombre:"Casa Harlaw",  provincia:"Harlaw", escudo:"harlaw.png",plot:" Domina la isla homónima, y la segunda más grande, dentro del territorio de la Casa Greyjoy. Es una de las casas más poderosas de las Islas del Hierro, rivalizado con la Casa Greyjoy en influencia y poder al ser la isla más poblada y rica en recursos."},
  {nombre:"Casa Stonehouse",  provincia:"Viejo Wyk", escudo:"stonehouse.png",plot:" Es una de las casas nobles de las Islas del Hierro y vasalla de los Greyjoy. Su asentamiento en la isla de Viejo Wyk, donde desembarcaron los Primeros Hombres venidos del continente y dónde el Rey Gris asesinó al legendario dragón marino Nagga (donde se encuentra el trono ancestral de las Islas del Hierro)."},
  {nombre:"Casa Merlyn",  provincia:"Gran Wyk", escudo:"merlyn.png",plot:" La Casa Merlyn es una casa noble de la isla más grande de las Islas del Hierro, lo cual le ha permitido ser la única que tiene fortalezas tierra adentro, alejadas del mar. Son vasallos de la Casa Greyjoy."},
  {nombre:"Casa Greyjoy",  provincia:"Pyke", escudo:"greyjoy.png",plot:" Es una de las grandes casas de Poniente y casa principal de las Islas del Hierro, situadas en la costa oeste del continente. Su lema es: 'Nosotros no sembramos', haciendo alarde a la práctica ancestral de la piratería. Su fortaleza es Pyke, situado en la isla homónima."},
  {nombre:"Casa Westerling",  provincia:"El Risco", escudo:"westerling.png",plot:" Casa situada en las Tierras del Oeste, bajo el dominio Lannister. Pese a ser una familia orgullosa carecieron de fondos para mantenerla la fortaleza familiar en El Risco,  que ha sido sumida en la ruina. Su lema es: 'Honor, no Honores'."},
  ...
  {nombre:"Casa Hewett",  provincia:"Islas Escudo", escudo:"hewett.png",plot:" Las Islas Escudo es un archipiélago formado por cuatro islas: Escudo de Roble, Escudo Gris, Escudo del Sur y Escudo Verde. Es archipiélago está bajo el mandato de la Casa Hewett de Isla Escudo de Roble, a su vez bajo la regencia de la casa Tyrell del Dominio. Su asentamiento es la primera línea defensiva contra incursiones piratas de las Islas del Hierro y sirve de protección al Dominio."},
  {nombre:"Casa Mullendore",  provincia:"Tierras Altas", escudo:"mullendore.png",plot:" Es una casa noble del dominio y vasalla de los Tyrell, fieles al gobierno de los Targaryen. Su asentamiento, Tierras Altas, está situado al noroeste de Antigua."},
  {nombre:"Casa Tarly",  provincia:"Colina Cuerno", escudo:"tarly.png",plot:" Casa vasalla de la familia Tyrell y ubicada en el Dominio, situada entre las colinas bajo las Montañas Rojas de Dorne. Es una casa antigua y honorable, con tierras ricas y una fortaleza fuerte. Su lema es: ‘Primeros en Batalla’ y poseen una espada de acero valyrio, ‘Veneno de Corazón’."},
  {nombre:"Casa Hightower",  provincia:"Antigua", escudo:"hightower.png",plot:" Los Hightower tienen sus tierras en territorio del Dominio, bajo regencia de los Tyrell. Su asentamiento es Antigua, la ciudad antigua más importante de Poniente, la segunda más poblada y tiene uno de los principales puertos comerciales de los Siete Reinos. En sus dominios también se encuentra la Ciudadela, lugar de formación de los maestres. Su lema es: ‘Iluminamos el camino’."},
  {nombre:"Casa Fowler",  provincia:"Dominio del Cielo", escudo:"fowler.png",plot:" El territorio de la casa está situado en Dorne, bajo dominio de la Casa Martell, al inicio del Paso del Príncipe (por lo cual ostentan el título de ‘Guardianes del Paso del Príncipe’). Su asentamiento tiene el nombre de Dominio del Cielo por su posición elevada  y sus altas torres de piedra, desde donde se ve todo el Camino Ancho. Su lema es: ‘Déjame ascender’."},
  {nombre:"Casa Caron de Nocturnia",  provincia:"Marcas de Dorne", escudo:"caron.png",plot:" Casa noble vasalla de la Casa Baratheon, quién le legó la regencia de las Marcas de Dorne (cadena montañosa que separa los territorios de las Tierras de la Tormenta y Dorne). Ostenta por ello el título de ‘Señorde las Marcas’. Su lema es: ‘Ninguna canción más dulce’."},
  {nombre:"Casa Yronwood",  provincia:"Palosanto", escudo:"yronwood.png",plot:" El territorio de los vasallos de los Martell está situado al comienzo de Sendahueso y protege a Dorne de los intrusos que quieran acceder a la región cruzando el paso. Debido a la importancia de su función como protectores tienen diversos títulos como ‘Guardián de Sendahueso’, ‘Señor de Palosanto’, ‘Sangre Regia’… Su lema es: ‘Nosotros protegemos el camino’."},
  ...
  {nombre:"Casa Jordayne",  provincia:"Tor", escudo:"jordayne.png",plot:" Su asentamiento está situado en la costa sur del Mar de Dorne, lo que les coloca bajo el mando de la Casa Martell.  Su lema es: ‘Deja que sea escrito’."},
  {nombre:"Casa Qorgyle",  provincia:"Asperon", escudo:"qorgyle.png",plot:" El territorio de la Casa Qorgyle está situado  más allá del río Vaith, en los profundo del desierto de Dorne, alrededor del único pozo en 50 leguas a la redonda. Son vasallos de los Martell."},
  {nombre:"Casa Dayne",  provincia:"Campoestrella", escudo:"dayne.png",plot:" El territorio de la casa está situado en una isla del río Torrentino y guarda la región occidental del Dorne. Dentro de la familia se disputa el título de 'Espada del Alba', el merecedor de blandir el mandoble ancestral de la casa, Albor, creado con el corazón de la estrella fugaz que cayó en el lugar donde después se edificó el asentamiento."}
];
